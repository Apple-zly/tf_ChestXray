...
class Vgg16:
    def __init__(self, images, name):
        self.name = name
        self.input = images
        self.output = self.vgg16(self.input, 0.8)
    ...
    def vgg16(self, x, keep_prob):
        ...
        fc7 = self.fc_layer(fc6_drop, out_units=4096, name='fc7')
        fc7_relu = tf.nn.relu(fc7)
        fc7_drop = tf.nn.dropout(fc7_relu, keep_prob, name='fc7_drop')

        fc8 = self.fc_layer(fc7_drop, out_units=4, name='fc8')
